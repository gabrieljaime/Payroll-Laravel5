...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head lang="en">
        ...
        <meta name="description" content="Recibos de Sueldos Disponibles">
                                    ...
                                    <tr>
                                        <td width="100%" valign="top" bgcolor="#e7e7e7">
                                            ...
                                            <div id="synopsis" style="display: none; font-size: 1px; color: #e7e7e7; line-height: 1px; font-family:'Helvetica Neue', Helvetica, Arial, sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden; mso-hide: all;">
                                                   Recibos disponibles para descagar
                                            </div>
                                            <!-- END PREFACE -->
                                            <!-- START SEPERATOR -->
                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top" bgcolor="#ffffff" style="padding: 40px 40px 17px 40px;" class="heading">
                                                                    <div class="login-logo">
                                                                        <a href="http://rrhh.cmlc.com.ar" style="margin-left: -23%" target="_blank" data-saferedirecturl="http://rrhh.cmlc.com.ar"> <img src="http://rrhh.cmlc.com.ar/storage/logolgin.png" class="CToWUd">
                                                                        </a>
                                                            ...
                                                            <tr>
                                                                <td align="left" bgcolor="#ffffff" style="padding: 0 25px 30px 25px;" class="body-text">
                                                                    <p style="font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size: 16px;line-height: 22px;text-decoration: none;font-weight: 400;">
                                                                        Se encuentran disponibles los recibos correspondientes a la última liquidación generada. Podra ingresar a descargarlos desde el siguente link.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                                                        ...
                                                                                                        <table align="center" border="0" cellpadding="0" cellspacing="0" style="max-width: 440px;" width="100%">
                                                                                                            <tr>
                                                                                                                <td style="text-align: center;">
                                                                                                                    <div>
                                                                                                                        <!--[if mso]>
                                                                                                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://rrhh.cmlc.com.ar/impresionrecibo" style="height:50px;v-text-anchor:middle;width: 450px;" arcsize="8%" strokecolor="#337ab7" fillcolor="#337ab7">
                                                                                                                            <w:anchorlock/>
