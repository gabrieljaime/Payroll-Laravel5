                    ...
                    <div class="box-body">
                        <div class="form-group form-inline">
                            {!! Form::label('legajo', 'Legajos:', ['class'=>'control-label ']) !!}
                                ...
                                {!! Form::select('legajo', $Legajos, $legajo , ['class' => 'form-control', 'required'])!!}
    ...
    <script type="text/javascript">
           $(function() {
               ...
               $('#TableinputRelojs thead').prepend(r);
                 ...
                 "serverSide": true,
                   "autoFill": true,
                    "dom": 'lrtip<"clear">',
                 "ajax": {
                    "url": '{{ URL::to('reloj/input/datal').'/'.$mes.'/'.$año.'/'.$legajo }}'
                },
                    buttons: {
                        dom: {
                                button: {
               ...
               $( "#buscar" ).click(function() {
                   ...
                   table.ajax.url( '{{ URL::to('reloj/input/datal/') }}/'+ mes +'/'+ anio+'/'+legajo).load();
