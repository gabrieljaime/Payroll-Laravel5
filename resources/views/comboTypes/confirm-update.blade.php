<div class="modal fade modal-primary" id="confirmEditT" role="dialog" aria-labelledby="confirmEditLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            {!! Form::open( ['route' => ['comboTypes.update', 'id'], 'method' => 'patch' , 'id'=>'updateT']) !!}
            <div class="modal-body" style="background-color: white !important;">
                <div class="box-body">
                    @include('comboTypes.fields', ['edit' => 'true'])
                </div>
            </div>
